...
class Welcome extends CI_Controller {
    ...
    /**
     * Genera un esquema a la base de datos a partir de entidades que creamos
     */
    ...
    public function addEmployeeFriends() {
        ...
        $friends = $beimar->getFriendsWithMe();
        //echo $friends;
        foreach ($friends as $friend) {
            echo $friend->getName() . '<br>';
            foreach ($friend->getMyFriends() as $otro) {
                echo $otro->getName() . '<br>';
                foreach ($otro->getMyFriends() as $tro1) {
                    echo $otro->getName() . '<br  >';
                }
            }
        }
